...
/**
 * Source SpringMongoConfig.java created on Jan 26, 2018
 *
...
@Configuration
public class SpringMongoConfig implements WebMvcConfigurer {

    public @Bean MongoDbFactory mongoDbFactory() throws Exception {
        return new SimpleMongoDbFactory(new MongoClient("centos7", 27017), "sample");
    }
